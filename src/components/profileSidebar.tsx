...
const ProfileSidebar: React.FC = () => {
  return (
    <div className=" xl:w-[23vw] lg:w-[30vw]  md:h-[80vh] sm:w-[92vw] pb-8  mt-12 xl:ml-[5rem] lg:ml-8 flex flex-col bg-[#1E1E1F]  items-center rounded-xl lg:fixed top-[4.5rem] border-[1px] border-gray-500">
